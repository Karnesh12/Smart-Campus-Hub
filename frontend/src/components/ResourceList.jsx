...
const typeIcons = {
    LECTURE_HALL: <Landmark size={40} />,
    LAB: <Laptop size={40} />,
    SPORTS: <Dumbbell size={40} />,
    STUDY_ROOM: <BookOpen size={40} />,
    AUDITORIUM: <Mic size={40} />,
    MEETING_ROOM: <Building2 size={40} />,
    OTHER: <Building2 size={40} />,
}
        ...
        <div className="resource-grid">
            {resources.map(r => (
                <div className="resource-card" key={r.id}>
                    <div className={`resource-card-img type-${r.type.toLowerCase()}`}>
                        <div className="resource-icon">
                            {typeIcons[r.type] || <Building2 size={40} />}
                        </div>
                    </div>
                    <div className="resource-card-body">
                        ...
                        <div className="resource-card-footer">
                            <span className="type-chip resource-type-chip">{r.type.replace('_', ' ')}</span>
                            {canManage && (
